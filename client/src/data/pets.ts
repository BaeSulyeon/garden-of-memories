...
export const samplePets: Pet[] = [
  {
    ...
    moonType: "full",
    moonDesign: "full-bright" as MoonDesignType,
    position: { x: 25, y: 30 },
    size: "large",
  },
  {
    ...
    moonType: "crescent",
    moonDesign: "crescent-light" as MoonDesignType,
    position: { x: 65, y: 25 },
    size: "medium",
  },
  {
    ...
    moonType: "gibbous",
    moonDesign: "gibbous-light" as MoonDesignType,
    position: { x: 45, y: 45 },
    size: "small",
  },
  {
    ...
    moonType: "full",
    moonDesign: "full-dark" as MoonDesignType,
    position: { x: 80, y: 50 },
    size: "medium",
  },
  {
    ...
    moonType: "crescent",
    moonDesign: "crescent-dark" as MoonDesignType,
    position: { x: 15, y: 60 },
    size: "small",
  },
  {
    ...
    moonType: "gibbous",
    moonDesign: "gibbous-dark" as MoonDesignType,
    position: { x: 55, y: 70 },
    size: "small",
  },
];
